...
from src.sports.schemas import SportCreateShema, SportObjectCreateSchema, SportObjectImageSchema
...
@sports_router.post("/")
async def add_sport(sport: Annotated[SportCreateShema, Depends(SportCreateShema)]):
...
async def add_sport_object(sport_object: Annotated[SportObjectCreateSchema, Depends(SportObjectCreateSchema)]):
